...
namespace WindowsFormsApplication1
{
    public partial class Form1 : Form
    {
        ...
        public Form1()
        {
            ...
            // Установка значений для размера пера
        ...
        private void button1_Click(object sender, EventArgs e) // Очистка
        {
        ...
        private void button3_Click(object sender, EventArgs e) // Цвет линии
        {
        ...
        private void FloodFill(int x1, int y1)
        {
            ...
            if ((oldPixelColor.ToArgb() != currentBorderColor.ToArgb()) && (oldPixelColor.ToArgb() != ZalivkaColor.ToArgb()))
            {
        ...
        private void button4_Click(object sender, EventArgs e) // цвет заливки
        {
